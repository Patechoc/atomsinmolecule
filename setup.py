...
#
# However, when we do this, we also import `atomsInMolecule/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'atomsInMolecule_cli = atomsInMolecule.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'atomsInMolecule_gui = atomsInMolecule.gui:entry_point'
        # ]
    }
)
